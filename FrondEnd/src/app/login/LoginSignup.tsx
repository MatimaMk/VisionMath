...
import EducationalSignupForm from "@/components/sign-upForm/page";
        ...
        <div className={styles.authContainer}>
          <div className={styles.brandSide}>
            ...
            <div className={styles.imageWrapper}>
              <Image
                src="https://png.pngtree.com/png-clipart/20211116/original/pngtree-math-formula-doodle-idea-with-transparent-background-png-image_6932262.png"
                alt="VisionMath"
                width={380}
                height={320}
                priority
