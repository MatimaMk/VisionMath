...
public abstract class visionMathWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static visionMathWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(visionMathWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<visionMathDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<visionMathDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<visionMathDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<visionMathDbContext, Task<T>> func)
    {
        T result;
