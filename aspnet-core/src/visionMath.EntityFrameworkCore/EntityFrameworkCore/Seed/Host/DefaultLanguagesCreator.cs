...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = visionMathConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(visionMathDbContext context)
    {
        _context = context;
    }
